...
\begin{center}
  \begin{longtable}{||p{5.5cm}|p{5.5cm}||} %longtable so it wraps %
    % pages   
    ...
    -setup\_select\_add & Builds candidate.cfg\\ %is there a difference
                                %between candidate.cfg and candidates.cfg
